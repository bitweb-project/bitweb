...
Bitweb Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Bitweb Core

**When configuring Bitweb Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Bitweb Core:
...
variables will be set when generating the Bitweb Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
