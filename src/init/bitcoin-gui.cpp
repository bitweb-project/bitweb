...
namespace init {
namespace {
const char* EXE_NAME = "bitweb-gui";
...
public:
    ...
    // bitweb-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // bitweb-node accepts the option, and bitweb-gui accepts all bitweb-node
