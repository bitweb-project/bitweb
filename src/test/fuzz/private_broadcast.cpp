...
//
// BACKPORT (upstream bitcoin/bitcoin PR #35129, commit 2ee4fafa3f48; not yet in 31.x
// as of 2026-07-04): DO NOT DROP ON NEXT UPSTREAM MERGE/REBASE.
// General-purpose fuzz harness for the PrivateBroadcast class. Exercises the public API
// (Add/Remove/PickTxForSend/GetTxForNode/NodeConfirmedReception/DidNodeConfirmReception/
// HavePendingTransactions/GetStale/GetBroadcastInfo) and checks its invariants, including
// the nodeid-uniqueness invariant enforced by the "enforce sending to unique node ids" fix.
