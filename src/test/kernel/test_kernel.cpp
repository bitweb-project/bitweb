...
BOOST_AUTO_TEST_CASE(btck_block_header_tests)
{
    ...
    auto mainnet_block_1_header = hex_string_to_byte_vec("00000020e609f211cafe9263f91ab64a9789750ffad424f9d774ab07c490b3b9c1921611b3812d77d1724b14816f4c8007ad1e5af29dd99d10b78e0661e97be2403b142032a8196affff0f1fab010000");
    BlockHeader header{mainnet_block_1_header};
    BOOST_CHECK_EQUAL(header.Version(), 536870912);
    BOOST_CHECK_EQUAL(header.Timestamp(), 1780066354);
    BOOST_CHECK_EQUAL(header.Bits(), 0x1f0fffff);
    BOOST_CHECK_EQUAL(header.Nonce(), 427);
    BOOST_CHECK_EQUAL(byte_span_to_hex_string_reversed(header.Hash().ToBytes()), "06ae146146168b6a9d844df251b9b0eaafbdb1173a9cf29f18014e256d62fb27");
    auto prev_hash = header.PrevHash();
    BOOST_CHECK_EQUAL(byte_span_to_hex_string_reversed(prev_hash.ToBytes()), "111692c1b9b390c407ab74d7f924d4fa0f7589974ab61af96392feca11f209e6");

    auto raw_block = hex_string_to_byte_vec("");
    Block block{raw_block};
    BlockHeader block_header{block.GetHeader()};
    BOOST_CHECK_EQUAL(block_header.Version(), 536870912);
    BOOST_CHECK_EQUAL(block_header.Timestamp(), 1780066354);
    BOOST_CHECK_EQUAL(block_header.Bits(), 0x1f0fffff);
    BOOST_CHECK_EQUAL(block_header.Nonce(), 427);
    BOOST_CHECK_EQUAL(byte_span_to_hex_string_reversed(block_header.Hash().ToBytes()), "06ae146146168b6a9d844df251b9b0eaafbdb1173a9cf29f18014e256d62fb27");
}
...
void chainman_mainnet_validation_test(TestDirectory& test_directory)
{
    ...
    BOOST_CHECK_EQUAL(byte_span_to_hex_string_reversed(tx.Txid().ToBytes()), "20143b40e27be961068eb7109dd99df25a1ead07804c6f81144b72d1772d81b3");
    BOOST_CHECK_EQUAL(header.Version(), 536870912);
    BOOST_CHECK_EQUAL(header.Timestamp(), 1780066354);
    BOOST_CHECK_EQUAL(header.Bits(), 0x1f0fffff);
    BOOST_CHECK_EQUAL(header.Nonce(), 427);
