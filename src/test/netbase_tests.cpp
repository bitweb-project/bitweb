...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:26333", "127.0.0.1", 26333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:26333", "127.0.0.1", 26333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:26333", "::ffff:127.0.0.1", 26333));
    BOOST_CHECK(TestSplitHost("[::]:26333", "::", 26333));
    BOOST_CHECK(TestSplitHost("::26333", "::26333", 0));
    BOOST_CHECK(TestSplitHost(":26333", "", 26333));
    BOOST_CHECK(TestSplitHost("[]:26333", "", 26333));
    ...
    BOOST_CHECK(TestSplitHost("www.bitwebcore.net:65536", "www.bitwebcore.net:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitwebcore.net:0", "www.bitwebcore.net", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitwebcore.net:", "www.bitwebcore.net:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:26333", "127.0.0.1:26333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:26333", "[::]:26333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
