...
enum class FeeEstimateMode {
    ...
    BTE_KVB,      //!< Use BTE/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from BTE/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BTE_KVB) const;
