...
static RPCHelpMan waitforblock()
{
    return RPCHelpMan{
        ...
        "Waits for a specific new block and returns useful info about it.\n"
                ...
                RPCExamples{
                    HelpExampleCli("waitforblock", "\"894768846de593f7f6572d1699641049131a5834666e039295ddfd402b255fd2\" 1000")
            + HelpExampleRpc("waitforblock", "\"894768846de593f7f6572d1699641049131a5834666e039295ddfd402b255fd2\", 1000")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    int timeout = 0;
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "document (<https://github.com/bitweb-project/bitweb/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
