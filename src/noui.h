...
/** Connect all bitwebd signal handlers */
void noui_connect();

/** Redirect all bitwebd signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
