...
{
    switch (unit) {
    case Unit::BTC: return QString("Bitwebs");
    case Unit::mBTC: return QString("Milli-Bitwebs (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Bitwebs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
