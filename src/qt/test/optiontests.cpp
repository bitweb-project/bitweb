...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Bitweb/Bitweb-Qt.conf and all else left as default,
    // bitweb-qt should set both -listen and -listenonion to false and start successfully.
