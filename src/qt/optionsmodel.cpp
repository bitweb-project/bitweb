...
//! Convert enabled/size values to bitweb -prune setting.
...
//! Get pruning enabled value to show in GUI from bitweb -prune setting.
...
//! Get pruning size value to show in GUI from bitweb -prune setting. If
