...
The interface runs on the same port as the JSON-RPC interface, by default port 1605 for mainnet, port 11605 for testnet,
port 31605 for signet, and port 18443 for regtest.
...
Example:
```
$ curl localhost:11605/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
   "chainHeight" : 325347,
