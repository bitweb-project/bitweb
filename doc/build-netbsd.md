...
It is not necessary to build wallet functionality to run bitwebd or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/bitweb-project/bitweb/blob/master/doc/descriptors.md).
...
Bitweb Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
