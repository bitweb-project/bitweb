...
stap net        inbound_message  0x000000000014419e /src/bitwebd
stap net        outbound_message 0x0000000000107c05 /src/bitwebd
stap validation block_connected  0x00000000002fb10c /src/bitwebd
…
```
...
```
$ readelf -n ./src/bitwebd | grep NT_STAPSDT -A 4 -B 2
