...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitwebd
...
considered active. This is the "traditional" mode of operation for bitwebd.
...
**Failure consideration:** if bitwebd unexpectedly halts after `m_stop_use` is set on
...
When bitwebd initializes again, what began as the snapshot chainstate is now
