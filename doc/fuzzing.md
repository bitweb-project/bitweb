...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`bitweb-project/qa-assets`](https://github.com/bitweb-project/qa-assets) repo.

Every single pull request submitted against the Bitweb Core repo is automatically tested against all inputs in the [`bitweb-project/qa-assets`](https://github.com/bitweb-project/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitweb Core more robust.
...
Bitweb Core follows its [security disclosure policy](https://bitcoincore.org/en/security-advisories/),
