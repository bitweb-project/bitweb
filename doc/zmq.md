...
The ZeroMQ feature in Bitweb Core requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ bitwebd -zmqpubhashtx=tcp://127.0.0.1:28332 \
...
These options can also be provided in bitweb.conf.
