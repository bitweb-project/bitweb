...
"""Verify that starting bitweb with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitweb with -h for help text")
        ...
        self.log.info("Start bitweb with -version for version information")
        ...
        self.log.info("Start bitwebd with -fakearg to make sure it does not start")
