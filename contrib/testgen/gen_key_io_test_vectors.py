...
bech32_templates = [
  ...
  ('web',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('web',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('web',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('web',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
