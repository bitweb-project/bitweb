...
templates = [
  ...
  #                                  None = N/A
  ((PUBKEY_ADDRESS,),         20, (),   (False, 'mainnet',  None,  None), pubkey_prefix, pubkey_suffix),
  ((SCRIPT_ADDRESS,),         20, (),   (False, 'mainnet',  None,  None), script_prefix, script_suffix),
  ...
  ((PRIVKEY,),                32, (),   (True,  'mainnet',  False, None), (),            ()),
  ((PRIVKEY,),                32, (1,), (True,  'mainnet',  True,  None), (),            ()),
...
bech32_templates = [
  ...
  ('web',   0, 20, (False, 'mainnet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('web',   0, 32, (False, 'mainnet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('web',   1, 32, (False, 'mainnet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('web',   2,  2, (False, 'mainnet',  None, True), Encoding.BECH32M, (OP_2, 2)),
