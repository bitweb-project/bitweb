...
# Extract options
function __fish_bitweb_tx_get_options
...
# Extract commands
function __fish_bitweb_tx_get_commands
...
complete \
    --command bitweb-tx \
    --condition "not __fish_bitweb_seen_cmd (__fish_bitweb_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitweb_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitweb-tx \
    --arguments "(__fish_bitweb_tx_get_commands)" \
    --no-files
