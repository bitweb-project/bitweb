...
complete --command bitweb-qt --no-files

# Extract options
function __fish_bitwebqt_get_options
...
complete \
    --command bitweb-qt \
    --arguments "(__fish_bitwebqt_get_options --nofiles)"
