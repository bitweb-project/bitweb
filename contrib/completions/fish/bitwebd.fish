...
complete --command bitwebd --no-files

# Extract options
function __fish_bitwebd_get_options
...
complete \
    --command bitwebd \
    --arguments "(__fish_bitwebd_get_options --nofiles)"
